...
float4 main(PSIn psin) : COLOR
{
    ...
    float3 n_Color_Ramp_Color = lerp(lerp(float3(0.000000, 0.050000, 0.150000), float3(0.850000, 0.980000, 1.000000), saturate((n_Color_Ramp_Color_f - 0.000000) / 0.500000)), float3(0.000000, 0.050000, 0.150000), saturate((n_Color_Ramp_Color_f - 0.500000) / 0.500000));
    ...
    float3 n_Color_Ramp_Alpha = float3(lerp(lerp(0.000000, 1.000000, saturate((n_Color_Ramp_Alpha_f - 0.000000) / 0.500000)), 0.000000, saturate((n_Color_Ramp_Alpha_f - 0.500000) / 0.500000)), lerp(lerp(0.000000, 1.000000, saturate((n_Color_Ramp_Alpha_f - 0.000000) / 0.500000)), 0.000000, saturate((n_Color_Ramp_Alpha_f - 0.500000) / 0.500000)), lerp(lerp(0.000000, 1.000000, saturate((n_Color_Ramp_Alpha_f - 0.000000) / 0.500000)), 0.000000, saturate((n_Color_Ramp_Alpha_f - 0.500000) / 0.500000)));
